...
export const config = {
  matcher: ["/api/create-order", "/api/create-reservation", "/api/verify-ticket-email", "/api/join-queue", "/api/queue-heartbeat", "/api/verify-scanner-pin", "/api/send-ticket-email", "/api/send-confirmation-email", "/api/exchange-rates"],
};
