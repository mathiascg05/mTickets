...
function PinEntry({
  ...
  return (
    <div className="max-w-sm mx-auto py-8 space-y-6 px-4">
...
function ManualSearch({
  ...
  const results: ScanOrder[] = useMemo(() => {
    if (!trimmed) return [];
              ...
              <div className="flex items-center justify-between gap-2">
                <div className="min-w-0">
                  ...
                  <p className="text-xs text-muted truncate">
                    {o.cedula}
                    {o.ticketType?.name ? ` · ${o.ticketType.name}` : ""}
    ...
    <div>
      ...
      {scannedOrderId ? (
        ...
        <div className="space-y-6">
          ...
          <ManualSearch orders={orders} onSelect={setScannedOrderId} />
        </div>
      )}
    </div>
  );
