...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale: lang, namespace: "seo.legal.terms" });
  return {
    title: t("title"),
    description: t("description"),
    alternates: {
      canonical: lang === routing.defaultLocale ? "/terms" : `/${lang}/terms`,
      languages: { es: "/terms", en: "/en/terms" },
    },
  };
}
